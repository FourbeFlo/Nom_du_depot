...
<xsl:stylesheet 
    ...
    <xsl:template name="sidebar">
        <aside class="sidebar" id="mySidebar" aria-label="Menu principal">
            ...
            <ul>
                ...
                <li><a href="1_prose.html">Définition de la TEI </a></li>
                <li><a href="2_poeme_anneau.html">Poème de l'Anneau</a></li>
                <li><a href="3_prose_new.html">Définition de la TEI 2.0</a></li>
                <li><a href="4_poeme_new.html">Poème de l'Anneau 2.o</a></li>
            </ul>
        </aside>
    </xsl:template>
    ...
    <xsl:template name="navigation-bar">
        <nav>
            ...
            <div class="download">
                <a href="../my_document.tei" class="button" download="">[↓] XML-TEI</a>
